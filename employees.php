...
<div class="table-wrap"><table><thead><tr><th>#</th><th>Name</th><th>Role</th><th>Phone</th><th>Salary</th><th>Start Date</th><th>Status</th><th>Actions</th></tr></thead>
<tbody><?php $i=1; while($e=$employees->fetch_assoc()):?>
<tr><td class="text-muted"><?=$i++?></td><td class="td-bold"><?=htmlspecialchars($e['name'])?></td><td style="color:var(--text2);font-size:13px"><?=htmlspecialchars($e['role'])?></td><td><?=htmlspecialchars($e['phone'])?></td>
